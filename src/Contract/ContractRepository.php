...
final class ContractRepository
{
     ...
     *
     * @param array<string, array{models: list<string>, fields_by_model: array<string, array<string, array<string, mixed>>>, rules?: list<array{when?: array<string, mixed>, required?: list<string>, forbidden?: list<string>}>}>|null $contract
     */
     ...
     *
     * @return array{models: list<string>, fields_by_model: array<string, array<string, array<string, mixed>>>, rules?: list<array{when?: array<string, mixed>, required?: list<string>, forbidden?: list<string>}>}|null
     */
